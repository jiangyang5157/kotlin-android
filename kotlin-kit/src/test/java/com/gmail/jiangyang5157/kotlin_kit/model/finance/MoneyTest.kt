...
class MoneyTest {
    ...
    @Test
    fun test_operator() {
        val JYP__3 = Money(-3, "JPY")
        val JYP_0 = Money(0, "JPY")
        val JYP_1 = Money(1, "JPY")
        val JYP_2 = Money(2, "JPY")
        val JYP_3 = Money(3, "JPY")
        val JYP_4 = Money(4, "JPY")
        val JYP_5 = Money(5, "JPY")
        val JYP_6 = Money(6, "JPY")
        val JYP_7 = Money(7, "JPY")
        val JYP_8 = Money(8, "JPY")
        val JYP_9 = Money(9, "JPY")
        val JYP_10 = Money(10, "JPY")

        val USD__3 = Money(-300, "USD")
        val USD_0 = Money(0, "USD")
        val USD_1 = Money(100, "USD")
        val USD_1_1 = Money(110, "USD")
        val USD_1_11 = Money(111, "USD")
        val USD_1_12 = Money(112, "USD")
        val USD_2 = Money(200, "USD")
        val USD_3 = Money(300, "USD")
        val USD_3_3 = Money(330, "USD")
        val USD_3_33 = Money(333, "USD")
        val USD_3_34 = Money(334, "USD")
        val USD_4 = Money(400, "USD")
        val USD_5 = Money(500, "USD")
        val USD_6 = Money(600, "USD")
        val USD_6_6 = Money(660, "USD")
        val USD_6_66 = Money(666, "USD")
        val USD_7 = Money(700, "USD")
        val USD_8 = Money(800, "USD")
        val USD_9 = Money(900, "USD")
        val USD_9_99 = Money(999, "USD")
        val USD_10 = Money(1000, "USD")
