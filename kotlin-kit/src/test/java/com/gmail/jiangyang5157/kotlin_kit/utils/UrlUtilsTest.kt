...
class UrlUtilsTest {
    ...
    fun test_matches() {
        ...
        assertFalse(UrlUtils.matches("hhttp://developer.android.com/index.html"))
        assertFalse(UrlUtils.matches(""))
        assertFalse(UrlUtils.matches("developer.android.com/index.html"))
        assertFalse(UrlUtils.matches("https://"))
    ...
    fun test_extractFirst() {
        ...
        assertEquals(UrlUtils.extractFirst("http://developer.android.com/index.html"),
                "http://developer.android.com/index.html")
        assertEquals(UrlUtils.extractFirst("https://developer.android.com/index.html"),
                "https://developer.android.com/index.html")
        assertEquals(UrlUtils.extractFirst("asd//####https://developer.android.com/index.html"),
                "https://developer.android.com/index.html")
        assertEquals(UrlUtils.extractFirst("https://de-ve-lo..per.android.com/index.html"),
                "https://de-ve-lo..per.android.com/index.html")
        assertEquals(UrlUtils.extractFirst("https://developer.android.com/in-dex.html"),
        ...
        assertEquals(UrlUtils.extractFirst("(https://developer.android.com/index.html)"),
                "https://developer.android.com/index.html")
        assertEquals(UrlUtils.extractFirst("https://developer.an::droid.com/index.html)"),
                "https://developer.an::droid.com/index.html")
        assertEquals(UrlUtils.extractFirst("https://dev#eloper.an::droid.com/index.html)"),
                "https://dev")
        assertEquals(UrlUtils.extractFirst("http://developer.android.com/index.html/"),
                "http://developer.android.com/index.html")
        assertEquals(UrlUtils.extractFirst("http://developer.android.com/index.html///"),
                "http://developer.android.com/index.html")
        assertEquals(UrlUtils.extractFirst("http://developer.android.com/index.html///asdasd-asd.asd--asd//"),
                "http://developer.android.com/index.html")
        assertEquals(UrlUtils.extractFirst("Indonesia<br>BaliIsForMe.com (http://www.BaliIsForMe.com)"),
