package com.gmail.jiangyang5157.kotlin_kit.data.model.finance
...
class MoneyTest {
    ...
    fun test_constructor_default() {
        assertEquals("0.00", Money(
            0
        ).amount.toString())
//        assertEquals("NZD", Money(0).currency.currencyCode.toString())
        assertEquals(RoundingMode.HALF_UP, Money(
            0
        ).roundingMode)
    }
    ...
    fun test_string2Double() {
        ...
        assertEquals("1.00", Money(
            "0001.".toDouble(),
            countryCode
        ).amount.toString())
        assertEquals("0.10", Money(
            ".10".toDouble(),
            countryCode
        ).amount.toString())
        assertEquals("-0.10", Money(
