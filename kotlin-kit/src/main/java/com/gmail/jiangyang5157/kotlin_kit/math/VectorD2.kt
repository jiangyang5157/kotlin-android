 ...
 */
data class VectorD2(override val x: Double, override val y: Double) : Vector2<Double> {
    ...
    override val normalize: VectorD2
        get() = this / length
    ...
    override fun rotate(radian: Double): VectorD2 {
