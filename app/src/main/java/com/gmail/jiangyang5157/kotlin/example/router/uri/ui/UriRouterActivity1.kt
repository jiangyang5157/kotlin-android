...
class UriRouterActivity1 : AppCompatActivity(), RouterFragmentActivitySupport<String> {

    @Suppress("UNCHECKED_CAST")
    override val router: FragmentRouter<RouteData<String>> by lazy { RouterApi["UriRouterActivity1"].router as FragmentRouter<RouteData<String>> }

    @Suppress("UNCHECKED_CAST")
    override val routeBuilder: RouteBuilder<String> by lazy { RouterApi["UriRouterActivity1"].routeBuilder as RouteBuilder<String> }
