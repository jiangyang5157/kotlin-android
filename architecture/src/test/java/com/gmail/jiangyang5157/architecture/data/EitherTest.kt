...
class EitherTest {
    ...
    fun leftShouldReturnCorrectType() {
        val result = Either.Left(RuntimeException())
    ...
    fun mapRightValue() {
        ...
        assertEquals(Either.Right(Either.Right(11)), rightValue.map { Either.Right(11) })
        assertEquals(
            Either.Right(Either.Right(13)),
    ...
    fun flatMapRightValue() {
        ...
        assertEquals(Either.Right(12), rightValue.flatMap { Either.Right(it + 10) })
        assertEquals(Either.Right(11), rightValue.flatMap { Either.Right(11) })
    }
    ...
    fun foldValues() {
        ...
        val leftValue = Either.Left(RuntimeException())
        leftValue.fold(
            {
